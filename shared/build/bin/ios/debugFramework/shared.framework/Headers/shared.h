...
@class SharedSelectAllLaunchesInfo, SharedRuntimeQuery<__covariant RowType>, SharedRocket, SharedLaunch, SharedDatabaseDriverFactory, SharedRocketLaunch, SharedLinks, SharedRocket_, SharedRuntimeTransacterTransaction, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinByteArray, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKotlinx_serialization_coreUpdateMode, SharedKotlinByteIterator, SharedKotlinEnum<E>;
